...
function receiveToastMessage(event) {
  const { message, status, title, action } = event.detail;
  ...
  switch (background) {
    case "alert-error":
      toast.querySelector("#toast-icon").innerHTML =
        `<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path>`;
      break;
    case "alert-info":
      toast.querySelector("#toast-icon").innerHTML =
        `<path stroke="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>`;
      break;
    case "alert-warning":
      toast.querySelector("#toast-icon").innerHTML =
