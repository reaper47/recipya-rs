...
use crate::core::auth::pwd::ContentToHash;

/// The default scheme identifier used for password hashing when no other scheme is specified.
pub const DEFAULT_SCHEME: &str = "02";

/// Represents the status of a password's hashing scheme.
#[derive(Debug)]
...
/// A trait representing a password hashing scheme.
#[enum_dispatch]
pub trait Scheme {
