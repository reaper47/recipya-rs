...
use crate::core::model::recipe::structs::{
...
use crate::core::model::recipe::{
    KeywordRecipe, NutritionForCreate, RecipeForCreate, Sections, ToolForCreate, VideoForCreate,
};
use crate::core::model::user::UserKeyword;
