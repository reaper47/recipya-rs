...
pub fn a_complete_recipe() -> (RecipeDetails, RecipeImages) {
    ...
    let updated_date =
        Date::from_calendar_date(2022, time::Month::February, 24).expect("russia invaded Ukraine");
    ...
    (
        RecipeDetails {
            recipe: Recipe {
                ...
                r#yield: recipe_c.r#yield.ok_or(4).expect("yield found"),
                language: "en".into(),
            ...
            additional_images,
            category: recipe_c.category.expect("category"),
