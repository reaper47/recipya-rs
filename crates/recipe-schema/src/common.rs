...
impl<'de> Deserialize<'de> for AudioObjectOrClipOrMusicRecording {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::AudioObjectOrClipOrMusicRecording::*;
...
impl<'de> Deserialize<'de> for ClipOrVideoObject {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::ClipOrVideoObject::*;
...
impl<'de> Deserialize<'de> for CreativeWorkOrHowToSectionOrHowToStepOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::CreativeWorkOrHowToSectionOrHowToStepOrText::*;
...
impl<'de> Deserialize<'de> for CreativeWorkOrItemListOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::CreativeWorkOrItemListOrText::*;
...
impl<'de> Deserialize<'de> for CreativeWorkOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::CreativeWorkOrText::*;
...
impl<'de> Deserialize<'de> for DateOrDateTime {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::DateOrDateTime::*;
...
impl<'de> Deserialize<'de> for DefinedTermOrTextOrUrl {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::DefinedTermOrTextOrUrl::*;
...
impl<'de> Deserialize<'de> for DistanceOrQuantitativeValue {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::DistanceOrQuantitativeValue::*;
...
impl<'de> Deserialize<'de> for HowToSupplyOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::HowToSupplyOrText::*;
...
impl<'de> Deserialize<'de> for HowToToolOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::HowToToolOrText::*;
...
impl<'de> Deserialize<'de> for ImageObjectOrUrl {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::ImageObjectOrUrl::*;
...
impl<'de> Deserialize<'de> for IntegerOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::IntegerOrText::*;
...
impl<'de> Deserialize<'de> for ListItemOrTextOrThing {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::ListItemOrTextOrThing::*;
...
impl<'de> Deserialize<'de> for LanguageOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::LanguageOrText::*;
...
impl<'de> Deserialize<'de> for MediaObjectOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::MediaObjectOrText::*;
...
impl<'de> Deserialize<'de> for MonetaryAmountOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::MonetaryAmountOrText::*;
...
impl<'de> Deserialize<'de> for OrganizationOrPerson {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::OrganizationOrPerson::*;
...
impl<'de> Deserialize<'de> for PropertyValueOrTextOrUrl {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::PropertyValueOrTextOrUrl::*;
...
impl<'de> Deserialize<'de> for QuantitativeValueOrText {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::QuantitativeValueOrText::*;
...
impl<'de> Deserialize<'de> for TextOrTextObject {
    ...
    where
        D: Deserializer<'de>,
    {
        use super::common::TextOrTextObject::*;
