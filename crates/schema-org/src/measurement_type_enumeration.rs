...
use crate::Action;
use crate::field::{
    MeasurementTypeEnumerationDescriptionFieldEnum, MeasurementTypeEnumerationIdentifierFieldEnum,
    MeasurementTypeEnumerationSubjectOfFieldEnum,
};
...
pub struct MeasurementTypeEnumeration {
    ...
    #[serde(default, deserialize_with = "one_or_many")]
    #[serde(skip_serializing_if = "is_smallvec_empty")]
    pub additional_type: SmallVec<[MeasurementTypeEnumerationAdditionalTypeFieldEnum; 1]>,
    ///<https://schema.org/identifier>
    #[serde(default, deserialize_with = "one_or_many")]
    #[serde(skip_serializing_if = "is_smallvec_empty")]
    pub identifier: SmallVec<[MeasurementTypeEnumerationIdentifierFieldEnum; 1]>,
    ...
    #[serde(default, deserialize_with = "one_or_many")]
    #[serde(skip_serializing_if = "is_smallvec_empty")]
    pub description: SmallVec<[MeasurementTypeEnumerationDescriptionFieldEnum; 1]>,
    ...
    #[serde(default, deserialize_with = "one_or_many")]
    #[serde(skip_serializing_if = "is_smallvec_empty")]
    pub subject_of: SmallVec<[MeasurementTypeEnumerationSubjectOfFieldEnum; 1]>,
