...
mod tests {
    ...
    mod tests_favourite_recipe {
        use super::*;
        use crate::recipes_routes::FavouriteParams;
        ...
        async fn test_get_user_has_recipes_ok() -> Result<()> {
            ...
            assert_html(
                ...
                vec![
                    ...
                    r#"<div id="list-recipes" class="min-h-0"><article id="list-recipes" class="grid gap-4 p-4 text-sm place-items-center grid-cols-1 sm:grid-cols-2 md:m-auto md:max-w-7xl md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:text-base" data-layout="with-aside">"#,
        ...
        fn assert_complete_recipe(res: TestResponse, recipe: RecipeForCreate) {
            assert_html(
                ...
                vec![
                    ...
                    r#"<div class="grid grid-flow-col border-gray-700 col-span-6 py-1 md:border-b md:grid-cols-3 md:row-span-1 print:border-none"><div class="flex justify-self-center items-center gap-1 cursor-default" title="Prep time">"#,
    ...
    mod tests_search {
        ...
        async fn test_empty_query_only_favourites_test() -> Result<()> {
            ...
            assert_html(
                res,
                vec![
                    r#"<h2 class="sm:font-semibold sm:w-[25ch] sm:break-words sm:min-h-14">Magic Potion</h2>"#,
                ],
            );
            Ok(())
        }
