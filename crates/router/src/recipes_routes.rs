...
mod tests {
    ...
    mod tests_duplicate_recipes {
        ...
        fn assert_recipe_form(res: TestResponse) {
            let expected = [
                ...
                r#"<textarea name="description" placeholder="This Thai curry chicken will make you drool." class="textarea textarea-ghost w-full h-full resize-none rounded-none focus:outline-none">This is the most delicious recipe!</textarea>"#,
    ...
    mod tests_recipes {
        ...
        use models::Recipe;
        use testing::utils::{
            assert_html, assert_must_be_logged_in, assert_not_in_html, create_app_state,
        };
