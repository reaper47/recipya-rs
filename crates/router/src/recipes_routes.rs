...
mod tests {
    ...
    mod tests_favourite_recipe {
        ...
        async fn test_mark_as_favourite_view_recipe_ok() -> Result<()> {
            ...
            let res = server.post(&base_uri(1)).form(&FavouriteParams {
