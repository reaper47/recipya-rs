    ...
    mod tests_get {
        ...
        async fn test_recipe_exists_flat_ingredients_instructions_ok() -> Result<()> {
            ...
            assert_html(
                &res,
                &[
                    r#"<div class="col-span-6 px-8 py-2 border-gray-700 md:rounded-bl-none md:col-span-4 print:hidden"><h2 class="font-semibold text-center underline pb-1">Instructions</h2><ol class="grid list-decimal"><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">ins1</div></div></li><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">ins2</div></div></li></ol></div>"#,
    ...
    fn assert_complete_recipe(res: &TestResponse, recipe: &RecipeForCreate, images: &RecipeImages) {
        assert_html(
            ...
            &[
                ...
                r#"<div class="col-span-6 px-8 py-2 border-gray-700 md:rounded-bl-none md:col-span-4 print:hidden"><h2 class="font-semibold text-center underline pb-1">Instructions</h2><div><h3 class="font-bold py-2">Sauce</h3><ol class="grid list-decimal"><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">Mix all these ingredients</div></div></li></ol></div><div><h3 class="font-bold py-2">Chicken</h3><ol class="grid list-decimal"><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">Turn the oven at 300 F</div></div></li><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">Soak the chicken in the lemon juice</div></div></li><li class="min-w-full py-2 select-none hover:bg-base-300"><div class="flex"><div class="whitespace-pre-line w-full transition-all" _="on mousedown toggle .line-through toggle .opacity-40">Bake for 35 minutes</div><div id="timer-container-2" class="timer-container"><button class="timer btn btn-sm btn-circle btn-ghost" title="Start 35m timer" _="on click add .hidden to me"#,
