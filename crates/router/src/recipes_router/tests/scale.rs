    ...
    async fn test_valid_double_yield() -> Result<()> {
        ...
        assert_html(
            ...
            vec![
                ...
                r#"<span class="px-2">4 lb chicken</span>"#,
                r#"<span class="px-2">1 cup bread loaf</span>"#,
                r#"<span class="px-2">1 tbsp beef broth</span>"#,
                r#"<span class="px-2">15 cup flour</span>"#,
                r#"<span class="px-2">4 big apples</span>"#,
                r#"<span class="px-2">Lots of big apples</span>"#,
                r#"<span class="px-2">5 slices of bacon</span>"#,
                r#"<span class="px-2">4 2/3 cans of bamboo sticks</span>"#,
                r#"<span class="px-2">3can of tomato paste</span>"#,
                r#"<span class="px-2">13 1/2 peanut butter jars</span>"#,
                r#"<span class="px-2">1 1/2 cl of whiskey</span>"#,
                r#"<span class="px-2">1 1/3 tbsp lemon juice</span>"#,
                r#"<span class="px-2">Ground ginger</span>"#,
                r#"<span class="px-2">1 fresh pineapple, cored and cut into 1 1/2-inch pieces</span>"#,
                r#"<span class="px-2">Un sac de chips de 2 kg</span>"#,
                r#"<span class="px-2">Two 30-ounce can Goya beans</span>"#,
                r#"<span class="px-2">8 lb top quality chicken filet</span>"#,
                r#"<span class="px-2">1 1/3 tbsp lemon juice</span>"#,
            ],
        );
        Ok(())
