...
mod tests {
    ...
    async fn test_get_timeline_event_not_exist_ok() -> Result<()> {
        ...
        res.assert_status_internal_server_error();
        assert_ws_message(&mut ws_server, r#"{"showMessageHtmx":{"type":"toast","message":"Could not fetch timeline event.","status":"alert-error","title":"Operation Failed"}}"# ).await;
        Ok(())
    }
    ...
    async fn test_get_timeline_event_exists_ok() -> Result<()> {
        ...
        let res = server
            .get(&base_uri_timeline(1, event_id, 1, 5))
            .multipart(create_timeline_event_form())
            .await;
        ...
        assert_html(
            ...
            vec![
                ...
                r##"<div class="timeline-end"><p class="text-center">01/31/22</p></div><hr></li>"##,
            ],
        );
        Ok(())
    }
    ...
    #[tokio::test]
    async fn test_get_edit_timeline_event_recipe_not_exist_ok() -> Result<()> {
        todo!()
    }
    ...
    #[tokio::test]
    async fn test_put_edit_timeline_event_recipe_not_exist_ok() -> Result<()> {
        todo!()
    }
