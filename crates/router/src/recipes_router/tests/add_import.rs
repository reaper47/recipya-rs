        ...
        fn assert_other_json_html(res: TestResponse) {
            assert_html(
                ...
                vec![
                    ...
                    r#"<ul class="list grid gap-1"><li class="list-row py-1 no-after select-none grid grid-cols-1 hover:bg-base-300"><label class="flex items-center w-full"><input type="checkbox" class="checkbox"><span class="px-2">1 slice whole wheat bread</span></label></li></ul>"#,
                ],
            );
        }
