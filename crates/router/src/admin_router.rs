        ...
        mod tests_patch {
            ...
            async fn test_update_success_ok() -> Result<()> {
                ...
                assert_html(
                    res,
                    vec![
                        r##"<tr id="user-row-3"><th>1</th><td>slava@ukraini.ua</td><td></td><td class="grid grid-flow-col gap-2"><button type="button" class="btn btn-ghost btn-square btn-xs" hx-get="/admin/user/3" hx-target="#user-row-3" hx-swap="outerHTML" hx-vals="{&quot;row-index&quot;: &quot;0&quot;}"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg></button><button type="submit" class="btn btn-ghost btn-square btn-xs" hx-delete="/admin/user/3" hx-confirm="Are you sure you want to delete this user? This action is irreversible."><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0"></path></svg></button></td></tr>"##,
                    ],
                );
                Ok(())
            }
    ...
    mod tests_user_row {
        ...
        async fn test_valid_ok() -> Result<()> {
            ...
            assert_html(
                res,
                vec![
                    r##"<tr id="user-row-1"><th>4</th><td>test@test.com</td><td></td><td class="grid grid-flow-col gap-2"><button type="button" class="btn btn-ghost btn-square btn-xs" hx-get="/admin/user/1" hx-target="#user-row-1" hx-swap="outerHTML" hx-vals="{&quot;row-index&quot;: &quot;3&quot;}"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg></button><button type="submit" class="btn btn-ghost btn-square btn-xs" hx-delete="/admin/user/1" hx-confirm="Are you sure you want to delete this user? This action is irreversible."><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0"></path></svg></button></td></tr>"##,
                ],
            );
            Ok(())
        }
