        ...
        async fn test_sl_shared_logged_in_ok() -> Result<()> {
            ...
            assert_html(
                ...
                &[
                    ...
                    r#"<div class="grid"><div class="min-w-full sm:min-w-[33vw] place-self-center"><details open><summary class="text-left cursor-default">No label</summary><ol class="list bg-base-100 rounded-box shadow-md"><li class="list-row grid grid-cols-[1fr_auto]"><div class="grid gap-1 min-w-0"><label class="label text-base-content"><input class="checkbox peer" type="checkbox"><span class="peer-checked:line-through peer-checked:opacity-50 transition-all">Spaghetti</span></label></div></li></ol></details></div>"#,
                ],
            );
            assert_not_in_html(
                &res,
