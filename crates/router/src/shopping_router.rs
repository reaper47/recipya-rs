    ...
    mod tests_list_items {
        ...
        async fn test_item_valid_ok() -> Result<()> {
            ...
            assert_html(
                &res,
                &[
                    r#"<li class="list-row grid grid-cols-[1fr_auto]"><div class="grid gap-1 min-w-0"><label class="label text-base-content"><input class="checkbox peer" type="checkbox"><span class="peer-checked:line-through peer-checked:opacity-50 transition-all">Spaghetti (500g)</span></label></div><div class="flex gap-1">"#,
                    &format!(
        ...
        async fn test_put_item_ok() -> Result<()> {
            ...
            assert_html(
                &res,
                &[
                    r#"<li class="list-row grid grid-cols-[1fr_auto]"><div class="grid gap-1 min-w-0"><label class="label text-base-content"><input class="checkbox peer" type="checkbox"><span class="peer-checked:line-through peer-checked:opacity-50 transition-all">Apples (50)</span></label></div><div class="flex gap-1">"#,
                    &format!(
