use measurements::{Length, Mass, Temperature, Volume};
...
impl UnitConverter for Unit {
    fn convert(&self, to: UnitType) -> Result<Unit> {
        match (self, to) {
            // === LENGTH ===
            // From millimeter
            (Unit::Millimetre(value), UnitType::Millimetre) => Ok(self.with_value(*value)),
            (Unit::Millimetre(value), UnitType::Centimetre) => Ok(Unit::Centimetre(
                Length::from_millimetres(*value).as_centimetres(),
            )),
            (Unit::Millimetre(value), UnitType::Metre) => {
                Ok(Unit::Metre(Length::from_millimetres(*value).as_metres()))
            } 
            (Unit::Millimetre(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_millimetres(*value).as_kilometres()))
            }
            (Unit::Millimetre(value), UnitType::Inch) => {
                Ok(Unit::Inch(Length::from_millimetres(*value).as_inches()))
            }
            (Unit::Millimetre(value), UnitType::Foot) => {
                Ok(Unit::Foot(Length::from_millimetres(*value).as_feet()))
            }

            // From centimeter
            (Unit::Centimetre(value), UnitType::Millimetre) => Ok(Unit::Millimetre(
                Length::from_centimetres(*value).as_millimetres(),
            )),
            (Unit::Centimetre(value), UnitType::Centimetre) => Ok(Unit::Centimetre(*value)),
            (Unit::Centimetre(value), UnitType::Metre) => {
                Ok(Unit::Metre(Length::from_centimetres(*value).as_metres()))
            }
            (Unit::Centimetre(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_centimetres(*value).as_kilometres()))
            }
            (Unit::Centimetre(value), UnitType::Inch) => {
                Ok(Unit::Inch(Length::from_centimetres(*value).as_inches()))
            }
            (Unit::Centimetre(value), UnitType::Foot) => {
                Ok(Unit::Foot(Length::from_centimetres(*value).as_feet()))
            }

            // From meter
            (Unit::Metre(value), UnitType::Millimetre) => Ok(Unit::Millimetre(
                Length::from_metres(*value).as_millimetres(),
            )),
            (Unit::Metre(value), UnitType::Centimetre) => Ok(Unit::Centimetre(
                Length::from_metres(*value).as_centimetres(),
            )),
            (Unit::Metre(value), UnitType::Metre) => Ok(Unit::Metre(*value)),
            (Unit::Metre(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_metres(*value).as_kilometres()))
            }
            (Unit::Metre(value), UnitType::Inch) => {
                Ok(Unit::Inch(Length::from_metres(*value).as_inches()))
            }
            (Unit::Metre(value), UnitType::Foot) => {
                Ok(Unit::Foot(Length::from_metres(*value).as_feet()))
            }
            
            // From kilometre
            (Unit::Kilometre(value), UnitType::Millimetre) => Ok(Unit::Millimetre(
                Length::from_kilometres(*value).as_millimetres(),
            )),
            (Unit::Kilometre(value), UnitType::Centimetre) => Ok(Unit::Centimetre(
                Length::from_kilometres(*value).as_centimetres(),
            )),
            (Unit::Kilometre(value), UnitType::Metre) => Ok(Unit::Kilometre(*value)),
            (Unit::Kilometre(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_kilometres(*value).as_kilometres()))
            }
            (Unit::Kilometre(value), UnitType::Inch) => {
                Ok(Unit::Inch(Length::from_kilometres(*value).as_inches()))
            }
            (Unit::Kilometre(value), UnitType::Foot) => {
                Ok(Unit::Foot(Length::from_kilometres(*value).as_feet()))
            }

            // From inch
            (Unit::Inch(value), UnitType::Millimetre) => Ok(Unit::Millimetre(
                Length::from_inches(*value).as_millimetres(),
            )),
            (Unit::Inch(value), UnitType::Centimetre) => Ok(Unit::Centimetre(
                Length::from_inches(*value).as_centimetres(),
            )),
            (Unit::Inch(value), UnitType::Metre) => {
                Ok(Unit::Metre(Length::from_inches(*value).as_metres()))
            }
            (Unit::Inch(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_inches(*value).as_kilometres()))
            }
            (Unit::Inch(value), UnitType::Inch) => Ok(Unit::Inch(*value)),
            (Unit::Inch(value), UnitType::Foot) => {
                Ok(Unit::Foot(Length::from_inches(*value).as_feet()))
            }

            // From foot
            (Unit::Foot(value), UnitType::Millimetre) => {
                Ok(Unit::Millimetre(Length::from_feet(*value).as_millimetres()))
            }
            (Unit::Foot(value), UnitType::Centimetre) => {
                Ok(Unit::Centimetre(Length::from_feet(*value).as_centimetres()))
            }
            (Unit::Foot(value), UnitType::Metre) => {
                Ok(Unit::Metre(Length::from_feet(*value).as_metres()))
            }
            (Unit::Foot(value), UnitType::Kilometre) => {
                Ok(Unit::Kilometre(Length::from_feet(*value).as_kilometres()))
            }
            (Unit::Foot(value), UnitType::Inch) => {
                Ok(Unit::Inch(Length::from_feet(*value).as_inches()))
            }
            (Unit::Foot(value), UnitType::Foot) => Ok(Unit::Foot(*value)),

            // === MASS ===
            // From milligram
            (Unit::Milligram(value), UnitType::Milligram) => Ok(Unit::Milligram(*value)),
            (Unit::Milligram(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_milligrams(*value).as_grams()))
            }
            (Unit::Milligram(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_milligrams(*value).as_dekagrams()))
            }
            (Unit::Milligram(value), UnitType::Hectogram) => Ok(Unit::Hectogram(
                Mass::from_milligrams(*value).as_hectograms(),
            )),
            (Unit::Milligram(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_milligrams(*value).as_kilograms()))
            }
            (Unit::Milligram(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_milligrams(*value).as_ounces()))
            }
            (Unit::Milligram(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_milligrams(*value).as_pounds()))
            }

            // From gram
            (Unit::Gram(value), UnitType::Milligram) => {
                Ok(Unit::Milligram(Mass::from_grams(*value).as_milligrams()))
            }
            (Unit::Gram(value), UnitType::Gram) => Ok(Unit::Gram(*value)),
            (Unit::Gram(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_grams(*value).as_dekagrams()))
            }
            (Unit::Gram(value), UnitType::Hectogram) => {
                Ok(Unit::Hectogram(Mass::from_grams(*value).as_hectograms()))
            }
            (Unit::Gram(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_grams(*value).as_kilograms()))
            }
            (Unit::Gram(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_grams(*value).as_ounces()))
            }
            (Unit::Gram(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_grams(*value).as_pounds()))
            }

            // From dekagram
            (Unit::Dekagram(value), UnitType::Milligram) => Ok(Unit::Milligram(
                Mass::from_dekagrams(*value).as_milligrams(),
            )),
            (Unit::Dekagram(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_dekagrams(*value).as_grams()))
            }
            (Unit::Dekagram(value), UnitType::Dekagram) => Ok(Unit::Dekagram(*value)),
            (Unit::Dekagram(value), UnitType::Hectogram) => Ok(Unit::Hectogram(
                Mass::from_dekagrams(*value).as_hectograms(),
            )),
            (Unit::Dekagram(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_dekagrams(*value).as_kilograms()))
            }
            (Unit::Dekagram(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_dekagrams(*value).as_ounces()))
            }
            (Unit::Dekagram(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_dekagrams(*value).as_pounds()))
            }

            // From hectogram
            (Unit::Hectogram(value), UnitType::Milligram) => Ok(Unit::Milligram(
                Mass::from_hectograms(*value).as_milligrams(),
            )),
            (Unit::Hectogram(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_hectograms(*value).as_grams()))
            }
            (Unit::Hectogram(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_hectograms(*value).as_dekagrams()))
            }
            (Unit::Hectogram(value), UnitType::Hectogram) => Ok(Unit::Hectogram(*value)),
            (Unit::Hectogram(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_hectograms(*value).as_kilograms()))
            }
            (Unit::Hectogram(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_hectograms(*value).as_ounces()))
            }
            (Unit::Hectogram(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_hectograms(*value).as_pounds()))
            }

            // From kilogram
            (Unit::Kilogram(value), UnitType::Milligram) => Ok(Unit::Milligram(
                Mass::from_kilograms(*value).as_milligrams(),
            )),
            (Unit::Kilogram(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_kilograms(*value).as_grams()))
            }
            (Unit::Kilogram(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_kilograms(*value).as_dekagrams()))
            }
            (Unit::Kilogram(value), UnitType::Hectogram) => Ok(Unit::Hectogram(
                Mass::from_kilograms(*value).as_hectograms(),
            )),
            (Unit::Kilogram(value), UnitType::Kilogram) => Ok(Unit::Kilogram(*value)),
            (Unit::Kilogram(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_kilograms(*value).as_ounces()))
            }
            (Unit::Kilogram(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_kilograms(*value).as_pounds()))
            }

            // From ounce
            (Unit::Ounce(value), UnitType::Milligram) => {
                Ok(Unit::Milligram(Mass::from_ounces(*value).as_milligrams()))
            }
            (Unit::Ounce(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_ounces(*value).as_grams()))
            }
            (Unit::Ounce(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_ounces(*value).as_dekagrams()))
            }
            (Unit::Ounce(value), UnitType::Hectogram) => {
                Ok(Unit::Hectogram(Mass::from_ounces(*value).as_hectograms()))
            }
            (Unit::Ounce(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_ounces(*value).as_kilograms()))
            }
            (Unit::Ounce(value), UnitType::Ounce) => Ok(Unit::Ounce(*value)),
            (Unit::Ounce(value), UnitType::Pound) => {
                Ok(Unit::Pound(Mass::from_ounces(*value).as_pounds()))
            }

            // From pound
            (Unit::Pound(value), UnitType::Milligram) => {
                Ok(Unit::Milligram(Mass::from_pounds(*value).as_milligrams()))
            }
            (Unit::Pound(value), UnitType::Gram) => {
                Ok(Unit::Gram(Mass::from_pounds(*value).as_grams()))
            }
            (Unit::Pound(value), UnitType::Dekagram) => {
                Ok(Unit::Dekagram(Mass::from_pounds(*value).as_dekagrams()))
            }
            (Unit::Pound(value), UnitType::Hectogram) => {
                Ok(Unit::Hectogram(Mass::from_pounds(*value).as_hectograms()))
            }
            (Unit::Pound(value), UnitType::Kilogram) => {
                Ok(Unit::Kilogram(Mass::from_pounds(*value).as_kilograms()))
            }
            (Unit::Pound(value), UnitType::Ounce) => {
                Ok(Unit::Ounce(Mass::from_pounds(*value).as_ounces()))
            }
            (Unit::Pound(value), UnitType::Pound) => Ok(Unit::Pound(*value)),
...
mod tests {
    ...
    mod test_convert_length {
        use super::*;

        #[test]
        fn test_millimeter_conversions() -> Result<()> {
            assert_eq!(
                Unit::Millimetre(100.0).convert(UnitType::Millimetre)?,
                Unit::Millimetre(100.0)
            );
            assert_eq!(
                Unit::Millimetre(100.0).convert(UnitType::Centimetre)?,
                Unit::Centimetre(10.0),
            );
            assert_eq!(
                Unit::Millimetre(1000.0).convert(UnitType::Metre)?,
                Unit::Metre(1.0),
            );
            assert_eq!(
                Unit::Millimetre(1e6).convert(UnitType::Kilometre)?,
                Unit::Kilometre(1.0),
            );
            assert_eq!(
                Unit::Millimetre(25.4).convert(UnitType::Inch)?,
                Unit::Inch(1.0)
            );
            assert_eq!(
                Unit::Millimetre(304.8).convert(UnitType::Foot)?,
                Unit::Foot(1.0),
            );
            Ok(())
        }
        ...
        fn test_centimeter_conversions() -> Result<()> {
            assert_eq!(
                Unit::Centimetre(5.0).convert(UnitType::Millimetre)?,
                Unit::Millimetre(50.0),
            );
            assert_eq!(
                Unit::Centimetre(150.0).convert(UnitType::Centimetre)?,
                Unit::Centimetre(150.0),
            );
            assert_eq!(
                Unit::Centimetre(150.0).convert(UnitType::Metre)?,
                Unit::Metre(1.5),
            );
            assert_eq!(
                Unit::Centimetre(1e5).convert(UnitType::Kilometre)?,
                Unit::Kilometre(1.0),
            );
            assert_eq!(
                Unit::Centimetre(2.54).convert(UnitType::Inch)?,
                Unit::Inch(1.0),
            );
            assert_eq!(
                Unit::Centimetre(30.48).convert(UnitType::Foot)?,
                Unit::Foot(1.0),
            );
            Ok(())
        }
        ...
        fn test_meter_conversions() -> Result<()> {
            assert_eq!(
                Unit::Metre(2.5).convert(UnitType::Millimetre)?,
                Unit::Millimetre(2500.0),
            );
            assert_eq!(
                Unit::Metre(0.75).convert(UnitType::Centimetre)?,
                Unit::Centimetre(75.0),
            );
            assert_eq!(
                Unit::Metre(42.0).convert(UnitType::Metre)?,
                Unit::Metre(42.0),
            );
            assert_eq!(
                Unit::Metre(1e3).convert(UnitType::Kilometre)?,
                Unit::Kilometre(1.0),
            );
            assert_approx_eq(
                Unit::Metre(0.3048).convert(UnitType::Inch)?,
                Unit::Inch(12.0),
                1e-6,
            );
            assert_approx_eq(
                Unit::Metre(1.0).convert(UnitType::Foot)?,
                Unit::Foot(3.28084),
                1e-6,
            );
            Ok(())
        ...
        fn test_inch_conversions() -> Result<()> {
            assert_eq!(
                Unit::Inch(1.0).convert(UnitType::Millimetre)?,
                Unit::Millimetre(25.4),
            );
            assert_eq!(
                Unit::Inch(1.0).convert(UnitType::Centimetre)?,
                Unit::Centimetre(2.54),
            );
            assert_approx_eq(
                Unit::Inch(39.3701).convert(UnitType::Metre)?,
                Unit::Metre(1.0),
                1e-6,
            );
            assert_approx_eq(
                Unit::Inch(39370.1).convert(UnitType::Kilometre)?,
                Unit::Kilometre(1.0),
                1e-6,
            );
            assert_eq!(Unit::Inch(5.5).convert(UnitType::Inch)?, Unit::Inch(5.5),);
            assert_eq!(Unit::Inch(12.0).convert(UnitType::Foot)?, Unit::Foot(1.0),);
            Ok(())
        }
        ...
        fn test_foot_conversions() -> Result<()> {
            assert_eq!(
                Unit::Foot(1.0).convert(UnitType::Millimetre)?,
                Unit::Millimetre(304.8),
            );
            assert_eq!(
                Unit::Foot(1.0).convert(UnitType::Centimetre)?,
                Unit::Centimetre(30.48),
            );
            assert_eq!(
                Unit::Foot(1.0).convert(UnitType::Metre)?,
                Unit::Metre(0.3048),
            );
            assert_approx_eq(
                Unit::Foot(3280.84).convert(UnitType::Kilometre)?,
                Unit::Kilometre(1.0),
                1e-6,
            );
            assert_approx_eq(
                Unit::Foot(2.0).convert(UnitType::Inch)?,
                Unit::Inch(24.0),
                1e-6,
            );
            assert_eq!(Unit::Foot(7.25).convert(UnitType::Foot)?, Unit::Foot(7.25),);
            Ok(())
        }

        #[test]
        fn test_zero_conversion() -> Result<()> {
            let got = Unit::Metre(0.0).convert(UnitType::Inch)?;

            assert_approx_eq(got, Unit::Inch(0.0), 1e-10);
            Ok(())
        }

        #[test]
        fn test_negative_values() -> Result<()> {
            let got = Unit::Metre(-5.0).convert(UnitType::Centimetre)?;

            assert_approx_eq(got, Unit::Centimetre(-500.0), 1e-10);
            Ok(())
        }

        #[test]
        fn test_very_small_values() -> Result<()> {
            let got = Unit::Millimetre(0.001).convert(UnitType::Metre)?;

            assert_approx_eq(got, Unit::Metre(0.000001), 1e-12);
            Ok(())
        }

        #[test]
        fn test_very_large_values() -> Result<()> {
            let got = Unit::Metre(1000000.0).convert(UnitType::Millimetre)?;

            assert_approx_eq(got, Unit::Millimetre(1000000000.0), 1e-6);
            Ok(())
        }

        #[test]
        fn test_fractional_values() -> Result<()> {
            let got = Unit::Foot(0.5).convert(UnitType::Inch)?;

            assert_approx_eq(got, Unit::Inch(6.0), 1e-10);
            Ok(())
        }

        #[test]
        fn test_precise_decimal() -> Result<()> {
            let got = Unit::Metre(1.234567).convert(UnitType::Centimetre)?;

            assert_approx_eq(got, Unit::Centimetre(123.4567), 1e-10);
            Ok(())
        }

        #[test]
        fn test_height_conversion_6_feet() -> Result<()> {
            let got = Unit::Foot(6.0).convert(UnitType::Metre)?;

            assert_approx_eq(got, Unit::Metre(1.8288), 1e-4);
            Ok(())
        }

        #[test]
        fn test_height_conversion_180_cm() -> Result<()> {
            let got = Unit::Centimetre(180.0).convert(UnitType::Foot)?;

            assert_approx_eq(got, Unit::Foot(5.90551), 1e-4); // 180 cm ≈ 5.91 feet
            Ok(())
        }

        #[test]
        fn test_screen_size_24_inch() -> Result<()> {
            let got = Unit::Inch(24.0).convert(UnitType::Centimetre)?;

            assert_approx_eq(got, Unit::Centimetre(60.96), 1e-10); // 24 inches = 60.96 cm
            Ok(())
        }

        #[test]
        fn test_paper_size_a4_width() -> Result<()> {
            let got = Unit::Millimetre(210.0).convert(UnitType::Inch)?;

            assert_approx_eq(got, Unit::Inch(8.26772), 1e-4); // A4 width ≈ 8.27 inches
            Ok(())
        }
        ...
        fn test_round_trip_meter_inch() -> Result<()> {
            ...
            let to_inches = Unit::Metre(original).convert(UnitType::Inch)?;
            let back_to_meters = to_inches.convert(UnitType::Metre)?;

            assert_approx_eq(back_to_meters, Unit::Metre(original), 1e-10);
            Ok(())
        }
        ...
        fn test_round_trip_foot_millimeter() -> Result<()> {
            ...
            let to_mm = Unit::Foot(original).convert(UnitType::Millimetre)?;
            let back_to_feet = to_mm.convert(UnitType::Foot)?;

            assert_approx_eq(back_to_feet, Unit::Foot(original), 1e-10);
            Ok(())
        }
        ...
        fn test_round_trip_centimeter_inch() -> Result<()> {
            ...
            let to_inches = Unit::Centimetre(original).convert(UnitType::Inch)?;
            let back_to_cm = to_inches.convert(UnitType::Centimetre)?;

            assert_approx_eq(back_to_cm, Unit::Centimetre(original), 1e-10);
            Ok(())
        }

        #[test]
        fn test_international_foot_definition() -> Result<()> {
            let got = Unit::Foot(1.0).convert(UnitType::Metre)?;

            assert_approx_eq(got, Unit::Metre(0.3048), 1e-15);
            Ok(())
        }

        #[test]
        fn test_international_inch_definition() -> Result<()> {
            let got = Unit::Inch(1.0).convert(UnitType::Millimetre)?;

            assert_approx_eq(got, Unit::Millimetre(25.4), 1e-15);
            Ok(())
        }

        #[test]
        fn test_metric_definitions() -> Result<()> {
            let result1 = Unit::Metre(1.0).convert(UnitType::Centimetre)?;
            assert_approx_eq(result1, Unit::Centimetre(100.0), 1e-15);

            let result2 = Unit::Metre(1.0).convert(UnitType::Millimetre)?;
            assert_approx_eq(result2, Unit::Millimetre(1000.0), 1e-15);

            let result3 = Unit::Centimetre(1.0).convert(UnitType::Millimetre)?;
            assert_approx_eq(result3, Unit::Millimetre(10.0), 1e-15);
            Ok(())
        }
        ...
        fn test_complex_chain_conversion() -> Result<()> {
            ...
            let step1 = Unit::Millimetre(original).convert(UnitType::Centimetre)?;
            let step2 = step1.convert(UnitType::Metre)?;
            let step3 = step2.convert(UnitType::Foot)?;
            let got = step3.convert(UnitType::Inch)?;

            let want = Unit::Millimetre(original).convert(UnitType::Inch)?;
            assert_eq!(got, want);
            Ok(())
        }
    }

    mod test_convert_mass {
        use super::*;

        #[test]
        fn test_milligram_conversions() -> Result<()> {
            assert_eq!(
                Unit::Milligram(1000.0).convert(UnitType::Milligram)?,
                Unit::Milligram(1000.0),
            );
            assert_eq!(
                Unit::Milligram(1000.0).convert(UnitType::Gram)?,
                Unit::Gram(1.0),
            );
            assert_eq!(
                Unit::Milligram(10000.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(1.0),
            );
            assert_eq!(
                Unit::Milligram(100000.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(1.0),
            );
            assert_eq!(
                Unit::Milligram(1000000.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(1.0),
            );
            assert_approx_eq(
                Unit::Milligram(28349.5).convert(UnitType::Ounce)?,
                Unit::Ounce(1.0),
                0.1,
            );
            assert_approx_eq(
                Unit::Milligram(453592.0).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
                0.1,
            );
            Ok(())
        ...
        fn test_gram_conversions() -> Result<()> {
            assert_eq!(
                Unit::Gram(1.0).convert(UnitType::Milligram)?,
                Unit::Milligram(1000.0),
            );
            assert_eq!(Unit::Gram(1.0).convert(UnitType::Gram)?, Unit::Gram(1.0),);
            assert_eq!(
                Unit::Gram(10.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(1.0),
            );
            assert_eq!(
                Unit::Gram(100.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(1.0),
            );
            assert_eq!(
                Unit::Gram(1000.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(1.0),
            );
            assert_approx_eq(
                Unit::Gram(28.3495).convert(UnitType::Ounce)?,
                Unit::Ounce(1.0),
                0.01,
            );
            assert_approx_eq(
                Unit::Gram(453.592).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
                0.01,
            );
            Ok(())
        ...
        fn test_dekagram_conversions() -> Result<()> {
            assert_eq!(
                Unit::Dekagram(1.0).convert(UnitType::Milligram)?,
                Unit::Milligram(10000.0),
            );
            assert_eq!(
                Unit::Dekagram(1.0).convert(UnitType::Gram)?,
                Unit::Gram(10.0),
            );
            assert_eq!(
                Unit::Dekagram(1.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(1.0),
            );
            assert_eq!(
                Unit::Dekagram(10.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(1.0),
            );
            assert_eq!(
                Unit::Dekagram(100.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(1.0),
            );

            assert_approx_eq(
                Unit::Dekagram(2.83495).convert(UnitType::Ounce)?,
                Unit::Ounce(1.0),
                0.01,
            );
            assert_approx_eq(
                Unit::Dekagram(45.3592).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
                0.01,
            );
            Ok(())
        ...
        fn test_hectogram_conversions() -> Result<()> {
            assert_eq!(
                Unit::Hectogram(0.01).convert(UnitType::Milligram)?,
                Unit::Milligram(1000.0),
            );
            assert_eq!(
                Unit::Hectogram(0.01).convert(UnitType::Gram)?,
                Unit::Gram(1.0),
            );
            assert_eq!(
                Unit::Hectogram(1.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(10.0),
            );
            assert_eq!(
                Unit::Hectogram(1.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(1.0),
            );
            assert_eq!(
                Unit::Hectogram(10.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(1.0),
            );

            assert_approx_eq(
                Unit::Hectogram(0.283495).convert(UnitType::Ounce)?,
                Unit::Ounce(1.0),
                0.01,
            );
            assert_approx_eq(
                Unit::Hectogram(4.53592).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
                0.01,
            );
            Ok(())
        ...
        fn test_kilogram_conversions() -> Result<()> {
            assert_eq!(
                Unit::Kilogram(0.001).convert(UnitType::Milligram)?,
                Unit::Milligram(1000.0),
            );
            assert_eq!(
                Unit::Kilogram(0.001).convert(UnitType::Gram)?,
                Unit::Gram(1.0),
            );
            assert_eq!(
                Unit::Kilogram(0.01).convert(UnitType::Dekagram)?,
                Unit::Dekagram(1.0),
            );
            assert_eq!(
                Unit::Kilogram(0.1).convert(UnitType::Hectogram)?,
                Unit::Hectogram(1.0),
            );
            assert_eq!(
                Unit::Kilogram(1.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(1.0),
            );

            assert_approx_eq(
                Unit::Kilogram(0.0283495).convert(UnitType::Ounce)?,
                Unit::Ounce(1.0),
                0.001,
            );
            assert_approx_eq(
                Unit::Kilogram(0.453592).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
                0.001,
            );
            Ok(())
        ...
        fn test_ounce_conversions() -> Result<()> {
            assert_approx_eq(
                Unit::Ounce(1.0).convert(UnitType::Milligram)?,
                Unit::Milligram(28349.5),
                1.0,
            );
            assert_approx_eq(
                Unit::Ounce(1.0).convert(UnitType::Gram)?,
                Unit::Gram(28.3495),
                0.001,
            );
            assert_approx_eq(
                Unit::Ounce(1.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(2.83495),
                0.0001,
            );
            assert_eq!(
                Unit::Ounce(1.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(0.28349523125),
            );
            assert_approx_eq(
                Unit::Ounce(1.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(0.0283495),
                0.000001,
            );
            assert_eq!(Unit::Ounce(1.0).convert(UnitType::Ounce)?, Unit::Ounce(1.0),);
            assert_eq!(
                Unit::Ounce(16.0).convert(UnitType::Pound)?,
                Unit::Pound(1.0),
            );
            Ok(())
        }
        ...
        fn test_pound_conversions() -> Result<()> {
            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Milligram)?,
                Unit::Milligram(453592.37),
            );
            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Gram)?,
                Unit::Gram(453.59237),
            );
            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Dekagram)?,
                Unit::Dekagram(45.359237),
            );
            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Hectogram)?,
                Unit::Hectogram(4.5359237),
            );
            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(0.45359237),
            );

            assert_eq!(
                Unit::Pound(1.0).convert(UnitType::Ounce)?,
                Unit::Ounce(16.0),
            );
            assert_eq!(Unit::Pound(1.0).convert(UnitType::Pound)?, Unit::Pound(1.0),);
            Ok(())
        }
        ...
        fn test_edge_cases() -> Result<()> {
            assert_eq!(
                Unit::Gram(0.0).convert(UnitType::Kilogram)?,
                Unit::Kilogram(0.0),
            );
            assert_eq!(Unit::Pound(0.0).convert(UnitType::Ounce)?, Unit::Ounce(0.0),);
            assert_eq!(
                Unit::Gram(0.001).convert(UnitType::Milligram)?,
                Unit::Milligram(1.0),
            );
            assert_eq!(
                Unit::Kilogram(1000.0).convert(UnitType::Gram)?,
                Unit::Gram(1000000.0),
            );
            Ok(())
        }
        ...
        fn test_precision() -> Result<()> {
            ...
            let converted = Unit::Gram(original).convert(UnitType::Kilogram)?;

            let back_converted = converted.convert(UnitType::Gram)?;

            assert_approx_eq(back_converted, Unit::Gram(original), 0.001);
            Ok(())
        }
        ...
        fn test_identity_conversions() -> Result<()> {
            let test_cases = vec![
                (Unit::Gram(42.0), UnitType::Gram),
                (Unit::Kilogram(2.12), UnitType::Kilogram),
                (Unit::Pound(2.71), UnitType::Pound),
                (Unit::Ounce(1.41), UnitType::Ounce),
                (Unit::Milligram(999.0), UnitType::Milligram),
                (Unit::Dekagram(66.0), UnitType::Dekagram),
                (Unit::Hectogram(55.0), UnitType::Hectogram),
            ];

            for (unit, unit_type) in test_cases {
                let expected = match unit {
                    Unit::Gram(v) => Unit::Gram(v),
                    Unit::Kilogram(v) => Unit::Kilogram(v),
                    Unit::Pound(v) => Unit::Pound(v),
                    Unit::Ounce(v) => Unit::Ounce(v),
                    Unit::Milligram(v) => Unit::Milligram(v),
                    Unit::Dekagram(v) => Unit::Dekagram(v),
                    Unit::Hectogram(v) => Unit::Hectogram(v),
                    _ => Unit::Gram(0.0),
                };
